...
<main class="page">
    ...
    <section class="pageSection pageSection--flex">
        ...
        <section class="pageSection__frame" data-aos="zoom-in">
            <h3 class="pageSection__frame__header">
                CZP Premium w trosce o dobro klientów
            </h3>
            <p class="pageSection__frame__text">
                Ilość listków, szerokość rolki, średnicę tulejki możemy dopasować do potrzeb klienta. Standardowe pakowanie to 8 rolek w paczce i 8 paczek w worku zbiorczym. Istnieje możliwość innych sposobów pakowania, np.: 4x10, 6x5, 8x9.
            </p>
        </section>
    ...
    <section class="pageSection pageSection--flex">
        <img class="pageSection__img" src="<?php echo get_bloginfo('stylesheet_directory') . '/img/papier-toaletowy-1.png'; ?>" alt="papier-toaletowy-golub-dobrzyn" data-aos="zoom-in" />
        <img class="pageSection__img" src="<?php echo get_bloginfo('stylesheet_directory') . '/img/papier-toaletowy-2.png'; ?>" alt="papier-toaletowy-rypin" data-aos="zoom-in" />
    </section>
</main>
