...
<main class="page">
    ...
    <section class="pageSection pageSection--narrow" data-aos="fade-up">
        <h2 class="pageSection__header">
            Ofertujemy <b>ręczniki ZZ</b> z papieru
        </h2>
    ...
    <section class="pageSection pageSection--flex">
        <img class="pageSection__img" src="<?php echo get_bloginfo('stylesheet_directory') . '/img/reczniki-zz-biale.png'; ?>" alt="reczniki-zz-biale" data-aos="zoom-in" />
        <img class="pageSection__img" src="<?php echo get_bloginfo('stylesheet_directory') . '/img/reczniki-zz-szare.png'; ?>" alt="reczniki-zz-szare" data-aos="zoom-in" />
    </section>
</main>
